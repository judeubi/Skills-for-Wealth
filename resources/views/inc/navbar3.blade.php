...
<div class="dropdown">
    <a href="{{Route('student.logout')}}"><button onclick="return confirm('{{Auth::guard('admin')->user()->firstname}}, are you sure you want to logout?')" class="logoutbtn">Logout</button></a>
